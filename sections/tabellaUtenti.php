...
<table id="userTab">
    ...
    <?php foreach($users as $user): ?>
        <?php if($acapo==20){ echo ' </tbody></table></td>'; if($contatore<3){$acapo=1; $contatore=$contatore+1; echo $laTesta;}else{$acapo=1; $contatore=1; echo $laTesta1;}}
        else{ $acapo=$acapo+1; } ?>
        <tr>
            <td><input name="id<?php echo $user['username'];?>" value="0" type="checkbox" onclick="cambia('<?php echo $user['username'];?>')"></td>
